...
const addValues = (arr) => {
  // Solution code here...
  let array =arr.reduce((accumalator, value) => accumalator + value, 0);
  return array;
};
...
const addPurchases = (arr) => {
  // Solution code here...
  let array = arr.reduce((accumalator, value) => {return accumalator + value.purchasePrice;}, 0);
  return array;
};
...
const countNumberOfElements = (arr) => {
  // Solution code here...
  let item = arr.reduce((accumalator, value, index) => {
...
const returnNames = (arr) => {
  // Solution code here...
  let array = arr.reduce((accumalator, value) => {
    accumalator.push(value.name);
    return accumalator;
 }, []);
 return array;
};
...
const reversedString = (str) => {
  ...
  return string.reduce((accumalator, value) => {
